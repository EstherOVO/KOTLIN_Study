...
//  name = 30    추론된 Type이 String이기 때문에, 문자열만 대입 가능
    name = "전우치"
//  age = "홍길동"      추론된 Type이 int이기 때문에, 숫자만 대입 가능
    age = 40
...
//  코드에서는 평벙한 클래스로 보이지만, 실행 시점에 Primitive Type으로 실행
//  Boxing, UnBoxing 고려 없이 코틀린이 알아서 처리
    val longVal = 100L;     // Long 타입 추론
    val floatVal = 12.34F;  // Float 타입 추론
    val doubleVal = 12.34;  // Double 타입 추론
    val charVal = 'A';      // Char 타입 추론
